...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Books by Author Jon Johnson:");
        System.out.println(Arrays.toString(bookService.filterBooksByAuthor(new Author(1, "Jon", "Johnson"), books)));

        System.out.println("Books by Publisher Publisher_3:");
        System.out.println(Arrays.toString(bookService.filterBooksByPublisher(new Publisher(3, "Publisher_3"), books)));

        System.out.println("Books published after 1992:");
